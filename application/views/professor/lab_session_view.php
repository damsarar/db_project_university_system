            ...
            <div class="header3-wrap">
                ...
                <div class="header__navbar">
                    <ul class="list-unstyled">
                        ...
                        <li>
                            <a href="<?php echo base_url(); ?>index.php/professorrole/professor">
                ...
                <div class="account-wrap">
                    <div class="account-item account-item--style2 clearfix js-item-menu">
                        <div class="image">
                            <img src="<?php echo base_url(); ?>/assets/admintemplate/images/icon/professoravatar.jpg" alt="Admin" />
                        </div>
                        <div class="content">
                            <a class="js-acc-btn" href="#">Professor</a>
                        </div>
    ...
    <section class="p-t-20">
                    ...
                    <div class="table-data__tool">
                        ...
                        <div class="table-data__tool-right">
                            <button  class="au-btn au-btn-icon au-btn--green au-btn--small" id="btnadd">
                                <i class="zmdi zmdi-plus"></i>Add Lab Session</button>
                            <button  class="au-btn au-btn-icon au-btn--blue2 au-btn--small" id="btnupdate">
                                <i class="zmdi zmdi-edit"></i>Update Lab Session</button>
                            ...
                            foreach ($h->result() as $row)
                            {
                                ...
                                <td>
                                    <div class="table-data-feature">
                                        ...
                                        <a href="<?php echo base_url();?>/index.php/professorrole/lab_session/lab_session_delete/<?php echo $row-> Course_code?>">
                ...
                <div class="modal-content">
                    <form class="well form-horizontal" action="<?php echo base_url();?>/index.php/admind/professor/professor_add" method="post"  id="contact_form"  >
                        <fieldset>
                            ...
                            <!-- Form Name -->
                            <legend>Insert a New Lab Session </legend>
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label" >Graduate Student ID</label>
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        <select class="form-control">
                                            <?php
                            ...
                            <!-- Text input-->
                            <div class="form-group">
                                <label class="col-md-4 control-label">Lab Session Number</label>
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                                        <input name="labsesno"  class="form-control"  type="text">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label">Section Number</label>
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
                                        <input name="secno"  class="form-control" type="text">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label">Lab Location</label>
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                                        <input name="labloc"  class="form-control" type="text">
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container">
            <div id="popup2" class="modal">
                <div class="modal-content">
                    <form class="well form-horizontal" action="<?php echo base_url();?>/index.php/admind/professor/professor_update" method="post"  id="contact_form"  >
                        <fieldset>

                            <!-- Form Name -->
                            <legend>Update a Lab Session </legend>
