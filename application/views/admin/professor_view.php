                            ...
                            foreach ($h->result() as $row)
                            {
                                ...
                                <td>
                                    <div class="table-data-feature">
                                        ...
                                        <a href="<?php echo base_url();?>/index.php/admind/professor/professor_delete/<?php echo $row->Emp_ID?>">
            ...
            <div class="modal-content">
                <form class="well form-horizontal" action="<?php echo base_url();?>/index.php/admind/professor/professor_update" method="post"  id="contact_form"  >
                    <fieldset>
                        ...
                        <!-- Form Name -->
                        <legend>Update Professor Details</legend>
