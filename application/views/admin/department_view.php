...
<section class="p-t-20">
                ...
                <div class="table-data__tool">
                    ...
                    <div class="table-data__tool-right">
                        ...
                        <button  class="au-btn au-btn-icon au-btn--blue2 au-btn--small" id="btnupdate">
                            <i class="zmdi zmdi-edit"></i>Update Department</button>
                        ...
                        foreach ($d->result() as $row)
                        {
                            ...
                            <td>
                                <div class="table-data-feature">
                                    ...
                                    <a href="<?php echo base_url();?>/index.php/admind/department/department_delete/<?php echo $row->Dept_code?>">
    ...
    <div class="container">
        <div id="popup" class="modal">
            <div class="modal-content">
                <form class="well form-horizontal" action="<?php echo base_url();?>/index.php/admind/department/department_add" method="post"  id="contact_form"  >
                    <fieldset>

                        <!-- Form Name -->
                        <legend>Insert a New Department</legend>
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label">Department Head ID</label>
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
    ...
    <div class="container">
        <div id="popup2" class="modal">
            <div class="modal-content">
                <form class="well form-horizontal" action="<?php echo base_url();?>/index.php/admind/department/department_update" method="post"  id="contact_form"  >
                    <fieldset>
